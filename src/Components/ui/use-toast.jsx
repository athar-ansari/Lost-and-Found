...
const ToastAction = ({ altText, onClick, children }) => (
  <Button className="ml-2 p-4 font-extrabold tracking-wider" onClick={onClick}>
    {children || altText}
  </Button>
);

export { useToast, toast, ToastContainer, ToastAction };
