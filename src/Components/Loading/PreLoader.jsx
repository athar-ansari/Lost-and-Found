  ...
  return (
    <>
      <div className="h-screen flex flex-col justify-between overflow-hidden">
        <div className="upper-pic flex justify-between mt-5 xs:mt-9">
          <motion.img
        ...
        <div className="middle flex justify-center items-center">
          <motion.img
            ...
            className="w-1/4 -mt-48 lg:w-5/12 xs:w-1/2 rounded-xl shadow-2xl z-[98] xs:-mt-20"
            alt="image"
            initial={{ scale: 0.5 }}
            animate={controls}
          />
        </div>
        <div className="lower-pic flex justify-between mb-10  xs:mb-32  ">
          <motion.img
            src="https://res.cloudinary.com/dgg8xe2o3/image/upload/v1722928919/about3_lu4ryn.png"
            className="ml-48 shadow-xl w-1/6 -mt-48 lg:w-1/4 xs:w-1/3 lg:ml-20 xs:ml-8 xs:-mt-20"
            alt="image3"
            initial={{ y: 50 }}
            animate={{ y: 0 }}
            transition={{ duration: 2.5 }}
          ...
          <motion.img
            ...
            className="mr-48 shadow-xl w-1/6 -mt-48 lg:w-1/4 xs:w-1/3 lg:mr-20 xs:mr-8 xs:-mt-20"
            alt="image4"
            initial={{ y: 50 }}
            animate={{ y: 0 }}
            transition={{ duration: 2.5 }}
